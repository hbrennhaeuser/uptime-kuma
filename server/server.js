    ...
    io.on("connection", async (socket) => {
        ...
        socket.on("editMonitor", async (monitor, callback) => {
            try {
                ...
                bean.icinga2Url = monitor.icinga2Url;
                bean.icinga2Username = monitor.icinga2Username;
                bean.icinga2Password = monitor.icinga2Password;
                bean.icinga2IgnoreTls = monitor.icinga2IgnoreTls;
                bean.icinga2HostFilter = monitor.icinga2HostFilter;
                bean.icinga2ServiceFilter = monitor.icinga2ServiceFilter;
                bean.icinga2IgnoreWarning = monitor.icinga2IgnoreWarning;
                bean.icinga2IgnoreUnknown = monitor.icinga2IgnoreUnknown;
